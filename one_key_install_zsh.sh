...
#
# permalink: https://gist.github.com/thinkycx/2e21c3572a8d1fde21aad07a58fcf940
# OS:
#    20200910 centos 8.1 success
set -e
set -x
...
install_ubuntu(){
        ...
        # curl raw URL > one_key_install_zsh.sh
        # bash one_key_install_zsh.sh
...
install_tmux_plugins(){
        # tmux plugins
        mkdir ~/.tmux
        git clone https://github.com/tmux-plugins/tmux-resurrect.git ~/.tmux/
